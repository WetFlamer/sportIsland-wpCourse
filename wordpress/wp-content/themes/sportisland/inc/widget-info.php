...
class SI_Widget_info extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            ...
            [
                ...
                'description' => 'Выводит информацию о спорт-клубе под картой',
            ]
        );
    }
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('id-info'); ?>" type="text"
                name="<?php echo $this->get_field_name('info'); ?>" value="<?php echo $instance['text']; ?>" class="widefat">
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('id-var'); ?>">
                Выберите вариант отображения
            </label>
            <select id="<?php echo $this->get_field_id('id-var'); ?>" name="<?php echo $this->get_field_name('var'); ?>" ;
                class="widefat">
                <?php
