...
class SI_Widget_Social extends WP_Widget
{
    ...
    private $socials = [
        'fb' => [
            ...
            width="96.875px" height="96.875px" x="0px" y="0px"
       ...
       '
        ...
        'insta' => [
            ...
            '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            x="0px" y="0px"
            width="97.395px" height="97.395px" viewBox="0 0 97.395 97.395"
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id('id-link'); ?>" type="text"
                name="<?php echo $this->get_field_name('link'); ?>" value="<?php echo $instance['text']; ?>" class="widefat">
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('id-slug'); ?>">
                Выберите социальную сеть
            </label>
            <select id="<?php echo $this->get_field_id('id-slug'); ?>" name="<?php echo $this->get_field_name('slug'); ?>" ;
                class="widefat"> ?>
                <?php
