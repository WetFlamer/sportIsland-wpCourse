...
<div class="footer">
  <header class="main-header">
    <div class="wrapper main-header__wrap">
      ...
      <?php
      if (is_active_sidebar('si_footer')) {
    ...
    <div class="row main-footer__row">
      <div class="main-footer__widget main-footer__widget_copyright">
        <span class="widget-text">
          <?php
          if (is_active_sidebar('si_footer-column-1')) {
            dynamic_sidebar('si_footer-column-1');
          }
          ?>
        </span>
      </div>
      ...
      <div class="main-footer__widget main-footer__widget_social">
       <?php 
        if (is_active_sidebar('si_footer-column-3')) {
          dynamic_sidebar('si_footer-column-3');
        }
       ?>
      </div>
    </div>
